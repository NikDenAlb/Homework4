public class Main {
    ...
    public static void task4() {
        ...
        } else if (7 <= ageHuman && ageHuman <= 18) {
    ...
    public static void task5() {
        ...
        } else if (5 <= ageHuman && ageHuman <= 14) {
    ...
    public static void task6() {
        ...
        String sidichee = "сидячее";
        String stoyachee = "стоячее";
        short a;
        short b;
        String aS;
        String bS;
        ...
        if (standPlaces < seatPlaces) {
            ...
            if (passengersNumber < a) {
                ...
                System.out.println(", в нём точно ещё есть место, но, возможно, все сидячии или все стоячии места заняты.");
